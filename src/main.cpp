...
int main(int argc, char *argv[])
{
    ...
    if (!DatabaseManager::instance().openSQLite()) {
        QMessageBox::critical(nullptr, "Erreur", "Impossible d'ouvrir ou d'initialiser la base de données SQLite.");
        return 1;
    }
